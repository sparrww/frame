...
<head>
    ...
    <link href="<?php if(defined('PUBLIC_PATH')){echo PUBLIC_PATH;}?>Admin/Css/login.css" rel="stylesheet" type="text/css" />
    ...
    <script src="<?php echo skin();?>Js/IE6-PNg-min.js'}"></script>
        ...
        $(function(){
            data=$(".form").Validform({
                ...
                callback:function(data){
                    if(data.status=="y"){
                        top.location.href ="<?php echo app_url();?>home/index";
...
<body>
<div class="landing">
    <div class="logo"><img src="<?php echo skin();?>Image/logo.jpg" /></div>
