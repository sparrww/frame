...
<div id="main">
	<form method="post" action="<?php echo app_url('/article/save');?>" class="form">
		<div id="main_top">
			<dl id="article_ico">
	...
	<table cellspacing="0" class="add_art">
		<tr>
		<th>标题:</th>
			<td width="650"><input id="title" name="title" type="text" class="inputxt" style="width:300px"  datatype="*1-255" nullmsg="请填写信息！" ajaxurl="<?php echo app_url();?>article/ajaxTitle" value=""/></td>
